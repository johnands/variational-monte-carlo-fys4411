...
\noindent This report consists of three parts:
\begin{enumerate}
 \item Theory - mathematical description of the systems under consideration
 \begin{enumerate}
  \item Benchmarks - to validate our code
 \end{enumerate}
 \item Methods - description of the algorithms and how they are implemented
 \item Results - presentation and validation of results
 \item Conclusion
 \item Appendix - closed-form expressions used in code for speed-up
\end{enumerate}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width = 160mm]{error_10.png}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width = 160mm]{error_50.png}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width = 160mm]{error_100.png}
