...
\noindent In this project we compute the ground state energy for $N=2$, $N=6$, $N=12$ and $N=20$ electrons
...
and kinetic energies. We perform a timing analysis by comparing a serial and parallel code both with 
